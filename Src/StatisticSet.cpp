...
StatisticSet::StatisticItem::StatisticItem(const char axName[], double dValue)
{
	...
	sprintf_s(m_axItemName, "%s", axName);
	m_dValue = dValue;
...
StatisticSet::StatisticItem::StatisticItem(const char axName[], const char axString[])
{
	...
	sprintf_s(m_axItemName, "%s", axName);
	sprintf_s(m_axString, "%s", axString);
...
bool StatisticSet::setItem(char axName[], double dValue)
{
...
bool StatisticSet::setItem(char axName[], int iValue)
{
	return setItem(axName, (double)iValue);
}

bool StatisticSet::setItem(char axName[], char axString[])
{
...
void StatisticSet::IncItem(char axName[], double dIncValue)
{
...
StatisticSet::StatisticItem StatisticSet::getItem(char axName[])
{
	set<StatisticItem>::iterator iterFind = m_setValueItems.find(StatisticItem(axName, (double)0));
	if (iterFind == m_setValueItems.end())
	{
